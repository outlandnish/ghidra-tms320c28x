...
CASES="addr_modes misc_batch io_ports vcu_setsh bar modulo_addr sbrk_adrk fpu_display fpu_parallel fpu_flags c2xlp cla_all traps mac_ext56 shifts bitops loops_intr fw_gaps"
